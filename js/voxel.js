var voxel = (function() {
    ...
    var imageDataToArrayR = function (imageData) {
        // create an exportable array instead of the data part but with only the red component
        var temp = {
    ...
    var imagesLoaded = function() {
        // create a sort of double buffer in two context
        constants.init();
    ...
    var renderFrame = function() {
        ...
        for (var i = 0; i < constants.screen.width; i++) {
            ...
            while (distanceProbed < constants.pov.depthOfField && screenProjectedTop < constants.screen.height) {
                // a. find the projection of the current point on the screen space
            ...
            // c. if the top is lower than the top of the screen we fill it
    ...
    return {
        // you apps visible functions comme here
...
$(document).ready(function() {
    voxel.start('img/map.jpg', 'img/texture.jpg');

    // keyboard and mouse events binding
    $(document).keydown(function(event) {
        voxel.eventHandler(event);
    });
